...
public interface LinphoneCall {
	...
	public interface LinphoneCallListener {
		void onNextVideoFrameDecoded(org.linphone.core.LinphoneCall call);
		/**
		 * Invoked when a TMMBR RTCP packet is received.
		 */
		void tmmbrReceived(org.linphone.core.LinphoneCall call, int streamIndex, int bitrate);
	}
	...
	**/
	 ...
	 */
	org.linphone.core.LinphoneCall getReplacedCall();
	...
	**/
	 ...
	 **/
	org.linphone.core.LinphoneCall getTransfererCall();
	...
	**/
	org.linphone.core.LinphoneCall getTransferTargetCall();
	 ...
	 */
	void setListener(org.linphone.core.LinphoneCall.LinphoneCallListener listener);
