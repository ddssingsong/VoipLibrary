...
public interface LinphoneFriendList {
	...
	**/
	 ...
	 */
	void setListener(org.linphone.core.LinphoneFriendList.LinphoneFriendListListener listener);

	interface LinphoneFriendListListener {
		void onLinphoneFriendCreated(org.linphone.core.LinphoneFriendList list, LinphoneFriend lf);

		void onLinphoneFriendUpdated(org.linphone.core.LinphoneFriendList list, LinphoneFriend newFriend, LinphoneFriend oldFriend);

		void onLinphoneFriendDeleted(org.linphone.core.LinphoneFriendList list, LinphoneFriend lf);

		void onLinphoneFriendSyncStatusChanged(org.linphone.core.LinphoneFriendList list, org.linphone.core.LinphoneFriendList.State status, String message);
	}
