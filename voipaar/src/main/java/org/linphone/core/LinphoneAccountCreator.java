...
public interface LinphoneAccountCreator {
	interface LinphoneAccountCreatorListener {
		void onAccountCreatorIsAccountUsed(org.linphone.core.LinphoneAccountCreator accountCreator, RequestStatus RequestStatus);
		void onAccountCreatorAccountCreated(org.linphone.core.LinphoneAccountCreator accountCreator, RequestStatus RequestStatus);
		void onAccountCreatorAccountActivated(org.linphone.core.LinphoneAccountCreator accountCreator, RequestStatus RequestStatus);
		void onAccountCreatorAccountLinkedWithPhoneNumber(org.linphone.core.LinphoneAccountCreator accountCreator, RequestStatus RequestStatus);
		void onAccountCreatorPhoneNumberLinkActivated(org.linphone.core.LinphoneAccountCreator accountCreator, RequestStatus RequestStatus);
		void onAccountCreatorIsAccountActivated(org.linphone.core.LinphoneAccountCreator accountCreator, RequestStatus RequestStatus);
		void onAccountCreatorPhoneAccountRecovered(org.linphone.core.LinphoneAccountCreator accountCreator, RequestStatus RequestStatus);
		void onAccountCreatorIsAccountLinked(org.linphone.core.LinphoneAccountCreator accountCreator, RequestStatus RequestStatus);
		void onAccountCreatorIsPhoneNumberUsed(org.linphone.core.LinphoneAccountCreator accountCreator, RequestStatus RequestStatus);
		void onAccountCreatorPasswordUpdated(org.linphone.core.LinphoneAccountCreator accountCreator, RequestStatus RequestStatus);
	}
