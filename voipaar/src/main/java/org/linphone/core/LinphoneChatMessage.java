...
public interface LinphoneChatMessage {
	...
	interface StateListener {
		void onLinphoneChatMessageStateChanged(org.linphone.core.LinphoneChatMessage msg, State state);
	}
	...
	interface LinphoneChatMessageListener {
		 ...
		 */
		void onLinphoneChatMessageFileTransferReceived(org.linphone.core.LinphoneChatMessage msg, LinphoneContent content, LinphoneBuffer buffer);
		 ...
		 */
		void onLinphoneChatMessageFileTransferSent(org.linphone.core.LinphoneChatMessage msg, LinphoneContent content, int offset, int size, LinphoneBuffer bufferToFill);
		 ...
		 */
		void onLinphoneChatMessageFileTransferProgressChanged(org.linphone.core.LinphoneChatMessage msg, LinphoneContent content, int offset, int total);
	}
	 ...
	 */
	org.linphone.core.LinphoneChatMessage.State getStatus();
	 ...
	 */
	void setListener(org.linphone.core.LinphoneChatMessage.LinphoneChatMessageListener listener);
	/**
