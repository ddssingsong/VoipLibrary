...
public interface LinphoneFriend {
	...
	static class SubscribePolicy {
		 ...
		 * This policy implies that a decision has to be taken for each incoming subscription request notified by {@link LinphoneCoreListener#newSubscriptionRequest(LinphoneCore, org.linphone.core.LinphoneFriend, String)}
		 */
