...
abstract public class LinphoneCoreFactory {
	...
	static org.linphone.core.LinphoneCoreFactory theLinphoneCoreFactory;
	/**
	...
	public static final synchronized org.linphone.core.LinphoneCoreFactory instance() {
		try {
			if (theLinphoneCoreFactory == null) {
				...
				theLinphoneCoreFactory = (org.linphone.core.LinphoneCoreFactory) lFactoryClass.newInstance();
			}
		} catch (Exception e) {
