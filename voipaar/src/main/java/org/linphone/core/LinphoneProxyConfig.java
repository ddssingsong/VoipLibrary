 ...
 * Once created and filled properly the LinphoneProxyConfig can be given to LinphoneCore with {@link LinphoneCore#addProxyConfig(org.linphone.core.LinphoneProxyConfig)}. This will automatically triggers the registration, if enabled.<br>
...
public interface LinphoneProxyConfig {
	 ...
	 */
	public org.linphone.core.LinphoneProxyConfig edit();
	/**
	 ...
	 * @param value
	 */
	public org.linphone.core.LinphoneProxyConfig enableRegister(boolean value);
	/**
	 ...
	 * @param privacy_mask a or'd int of values defined in interface {@link Privacy}
	 */
	void setPrivacy(int privacy_mask);

	/**
	 * Get the privacy mask requested for this proxy config.
	 * @return the privacy mask as defined in interface {@link Privacy}
	 */
	int getPrivacy();
