...
public class LinphoneCallParamsImpl implements LinphoneCallParams {
	...
	public LinphoneCore.MediaEncryption getMediaEncryption() {
		return LinphoneCore.MediaEncryption.fromInt(getMediaEncryption(nativePtr));
	}
	...
	@Override
	public void addCustomSdpMediaAttribute(LinphoneCore.StreamType type, String name, String value) {
	...
	@Override
	public String getCustomSdpMediaAttribute(LinphoneCore.StreamType type, String name) {
	...
	@Override
	public void clearCustomSdpMediaAttributes(LinphoneCore.StreamType type) {
